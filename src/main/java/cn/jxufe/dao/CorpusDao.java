...
public interface CorpusDao {
     ...
     * @return
     */
    int deleteCorpus(@Param("currentUserNo") int currentUserNo, @Param("corpusName") String corpusName);
     ...
     */
    int updateCorpusNameByCorpusNo(@Param("currentUserNo") int currentUserNo, @Param("corpusName") String corpusName,
     ...
     * @return
     */
    int incrBlogNumByCorpusNo(@Param("currentUserNo") int currentUserNo, @Param("corpusName") String corpusName);
     ...
     * @return
     */
    int descBlogNumByCorpusNo(@Param("currentUserNo") int currentUserNo, @Param("corpusName") String corpusName);
}
